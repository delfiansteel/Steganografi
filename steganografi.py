...
path_gambar_input = 'img/Delfian.jpg'  # Ganti dengan path gambar Anda
path_gambar_output = 'img/Delfian_tersembunyi.jpg'  # Ganti dengan path output yang diinginkan
